...
#SBATCH --job-name=ray_jupyter_environ
...
export HF_HOME="/leonardo_scratch/fast/tra25_bbs/rmioli00/models/hub"
export HF_HUB_CACHE="/leonardo_scratch/fast/tra25_bbs/rmioli00/models/hub"
export HF_OFFLINE="1"
