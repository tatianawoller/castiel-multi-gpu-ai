...
![](fig/03_weather_prediction_dataset_map.png){ align=center }
:::::::::::note
...
![](fig/03_gradient_descent.png){ align=center }
...
![](fig/03_training_history_1_rmse.png){ align=center }
...
![](fig/03_regression_predictions_trainset.png){ align=center }

```python
plot_predictions(y_test_predicted, y_test, title='Predictions on the test set')
```
![](fig/03_regression_predictions_testset.png){ align=center }
...
![](fig/03_regression_test_5_naive_baseline.png){ align=center }
...
![](fig/03_training_history_2_rmse.png){ align=center }
...
![](fig/03_training_history_3_rmse_smaller_model.png){ align=center }
...
![](fig/03_training_history_3_rmse_early_stopping.png){ align=center }
...
![](fig/03_training_history_5_rmse_batchnorm.png){ align=center }
...
![](fig/03_regression_test_5_dropout_batchnorm.png){ align=center }
...
plot_predictions(y_test_predicted, y_test, title='Predictions on the test set')
```
![](fig/03_scatter_plot_basel_model.png){ align=center }
...
![](fig/03_tensorboard.png){ align=center }
:::
